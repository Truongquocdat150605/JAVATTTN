...
public interface NotificationRepository extends JpaRepository<Notification, Long> {
    ...
    // Lấy thông báo dành cho 1 user cụ thể + thông báo chung (targetUserId = null)
    ...
    @Query("SELECT COUNT(n) FROM Notification n WHERE (n.targetUserId = :userId OR n.targetUserId IS NULL) AND n.isRead = false")
